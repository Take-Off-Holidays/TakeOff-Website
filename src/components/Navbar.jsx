...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-transparent" role="navigation" aria-label="Main navigation">
        ...
        <div className="flex items-center justify-between h-16 sm:h-18 md:h-20 lg:h-22">
          ...
          <div className="hidden md:flex bg-white/30 backdrop-blur-lg border border-white/20 rounded-full px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 py-2 sm:py-2.5 shadow-lg overflow-x-auto max-w-[100%] self-start mt-1 sm:mt-1.5 md:mt-2">
            <ul className="flex items-center space-x-3 sm:space-x-4 md:space-x-5 lg:space-x-6 xl:space-x-8 whitespace-nowrap">
              ...
              <li><Link to="/packages" className="text-sm sm:text-base md:text-base lg:text-lg text-black hover:text-blue-600 transition-colors duration-300 font-medium" style={{fontFamily: "'Afacad', sans-serif"}}>
                Packages
              </Link></li>
              <li><Link to="/about" className="text-sm sm:text-base md:text-base lg:text-lg text-black hover:text-blue-600 transition-colors duration-300 font-medium" style={{fontFamily: "'Afacad', sans-serif"}}>
                About Us
              </Link></li>
              <li><Link to="/contact" className="text-sm sm:text-base md:text-base lg:text-lg text-black hover:text-blue-600 transition-colors duration-300 font-medium" style={{fontFamily: "'Afacad', sans-serif"}}>
                Contact Us
              </Link></li>
            </ul>
          </div>
          ...
          {/* Right Section */}
          <div className="flex items-center self-start mt-1 sm:mt-1.5 md:mt-2">
            ...
            <Link to="/application" className="hidden md:flex bg-white/30 backdrop-blur-lg border border-white/20 rounded-full px-3 sm:px-4 md:px-5 lg:px-6 py-1.5 sm:py-2 md:py-2.5 flex items-center space-x-1 sm:space-x-1.5 hover:bg-white/20 transition-all duration-300 shadow-lg">
              <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
              </svg>
              <span className="text-sm sm:text-base text-black font-medium" style={{fontFamily: "'Afacad', sans-serif"}}>
                Booking
              </span>
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white/20 backdrop-blur-lg border-t border-white/20 shadow-lg" role="navigation" aria-label="Mobile navigation">
